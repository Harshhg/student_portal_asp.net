<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_login.aspx.cs" Inherits="login" %>
<!DOCTYPE HTML>
<html lang="zxx">
...
<body>
	...
	<asp:HyperLink  id= "l1" runat= "server" NavigateUrl="~/login.aspx"><h1>Admin Login </h1></asp:HyperLink>
	<!---728x90--->
